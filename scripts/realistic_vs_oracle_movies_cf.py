"""
Realistic vs Oracle Setting Experiment - Movies Dataset
Using CF Recall (NO TEXT REQUIRED)

This version uses Collaborative Filtering for recall instead of content-based,
solving the issue of poor item text quality in the Movies dataset.
"""
...
def main():
    print("="*80)
    print("Realistic vs Oracle Experiment - Movies Dataset (CF Recall)")
    print("="*80)
    ...
    # Save results
    output_path = f'/home/coder-gw/Projects/GraphLLMRec/experiments/logs/realistic_vs_oracle_movies_cf_128f.json'

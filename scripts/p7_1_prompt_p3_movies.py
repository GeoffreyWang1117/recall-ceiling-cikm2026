"""
Phase 7-1: Cross-dataset Prompt Validation - Movies Dataset

Validate P3 Enhanced CoT effectiveness on Movies dataset.
Compare P1 (baseline CoT) vs P3 (Enhanced CoT) to verify:
- P3 provides +200-400% NDCG@10 improvement (like Beauty)
- Enhanced preference signals help even with low recall (<3%)
"""
...
# ==================== Configuration ====================
CHECKPOINT_PATH = "experiments/logs/checkpoints/p7_1_prompt_movies_checkpoint.json"
RESULTS_PATH = "experiments/logs/p7_1_prompt_p3_movies.json"
...
def main():
    print("=" * 80)
    print("Phase 7-1: Cross-dataset Prompt Validation - Movies Dataset")
    print("=" * 80)
    ...
    # ==================== Display Results ====================
    print("\n" + "=" * 80)
    print("Phase 7-1 Results: Movies Dataset")
    print("=" * 80)
    print()
    ...
    print("\n" + "=" * 80)
    print("✓ Phase 7-1 (Movies) Complete!")
    print("=" * 80)

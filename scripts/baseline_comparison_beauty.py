"""
Baseline Comparison Experiment - Beauty Dataset
...
def main():
    print("="*80)
    print("Baseline Comparison Experiment - Beauty Dataset")
    print("="*80)
    ...
    # Save results
    output_path = f'/home/coder-gw/Projects/GraphLLMRec/experiments/logs/baseline_comparison_beauty.json'
